...
export default function Home() {
  return (
    <main>
      ...
      {/* 2 — About */}
      <RevealSection id="content" className="scroll-mt-16 bg-white px-6 py-14 sm:px-12">
        <div className="mx-auto flex max-w-lg flex-col items-center gap-8">
          <h2 className="w-full text-center text-3xl font-semibold tracking-tight text-neutral-900">
            About
          </h2>
      ...
      {/* 4 — Get in Touch */}
      <RevealSection className="bg-white px-6 py-14 text-center sm:px-12">
